...
阿里视频播放器的Pod库，做的是特定接口
  ...
  s.homepage         = 'https://github.com/2319587028@qq.com/ZHPlayVideo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '2319587028@qq.com' => '2319587028@qq.com' }
  s.source           = { :git => 'https://github.com/2319587028@qq.com/ZHPlayVideo.git', :tag => s.version.to_s }
